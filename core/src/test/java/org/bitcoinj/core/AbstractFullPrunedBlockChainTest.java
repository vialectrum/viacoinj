...
public abstract class AbstractFullPrunedBlockChainTest
{
    ...
    public void testUTXOProviderWithWallet() throws Exception {
        ...
        // Create 1 VIA spend to a key in this wallet (to ourselves).
        ...
        // Create another spend of 1/2 the value of VIA we have available using the wallet (store coin selector).
        ...
        // The availbale balance should be the 0 (as we spent the 1 VIA that's pending) and estimated should be 1/2 - fee VIA
        assertEquals("Available balance is incorrect", Coin.ZERO, wallet.getBalance(Wallet.BalanceType.AVAILABLE));
